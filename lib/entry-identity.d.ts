...
export declare const ENTRY_ID = "dsh-aigc-canvas";
/** Bundle package name (the Loader resolves the row's module through it). */
export declare const PACKAGE_NAME = "@huanlin/dsh-plugin-aigc-canvas";
/** `plugins.row.config` key: the bundle's package name `#` the patch row id. */
export declare const ROW_CONFIG_KEY = "@huanlin/dsh-plugin-aigc-canvas#dsh-aigc-canvas";
